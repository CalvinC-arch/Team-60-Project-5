...
public class TestingProfile implements Serializable{
    ...
    public TestingProfile(String username, ArrayList<String> interests, ArrayList<String> friends, String education,
    ...
    public TestingProfile(String filename) throws IOException {
